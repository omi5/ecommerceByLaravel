...
<div>
  <form action="">
    <input type="search" name="search" id="" placeholder="Search by Name or Email" value={{$search}}>
      ...
      <button><a href="{{url('/customer/view')}}">
...
<table id="customers">
  ...
  <tr>
    ...
    <td>
        ...
        <a href="{{url('/customer/edit')}}/{{$customer->customer_id}}"><button>Edit</button></a>
        
        <a href="{{route('customer.delete',['id' => $customer->customer_id])}}"><button>Move to trash</button></a>
